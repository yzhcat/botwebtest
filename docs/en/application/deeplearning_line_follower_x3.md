...
Among them, the two packages 10_model_convert and line_follower_model are placed in the [originbot_desktop code repository](https://github.com/guyuehome/originbot_desktop){:target="_blank"}，and line_follower_perception are placed in the [originbot code repository](https://github.com/guyuehome/originbot){:target="_blank"}.
